...
# from utility.global_variables import DEBUG
# from Training.Random_Forest import train_model
# from Training.Prepare_training_dataset import extract_training_data
from Prediction.prediction import predict

testing_url = 'https://www.google.com.naeemakhtar.com/path/end/here/virus.php'
print(predict(testing_url))
...
# if __name__ == '__main__':
    # predict('https://www.google.com.naeemakhtar.com/path/end/here/virus.php')
    # train_model()
    # try:
